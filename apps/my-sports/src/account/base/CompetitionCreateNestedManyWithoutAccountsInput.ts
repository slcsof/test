...
@InputType()
class CompetitionCreateNestedManyWithoutAccountsInput {
...
export { CompetitionCreateNestedManyWithoutAccountsInput as CompetitionCreateNestedManyWithoutAccountsInput };
