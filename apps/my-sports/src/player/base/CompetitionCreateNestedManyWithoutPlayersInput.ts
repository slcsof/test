...
@InputType()
class CompetitionCreateNestedManyWithoutPlayersInput {
...
export { CompetitionCreateNestedManyWithoutPlayersInput as CompetitionCreateNestedManyWithoutPlayersInput };
