...
@InputType()
class CompetitionCreateNestedManyWithoutAthletesInput {
...
export { CompetitionCreateNestedManyWithoutAthletesInput as CompetitionCreateNestedManyWithoutAthletesInput };
